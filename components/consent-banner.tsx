 ...
 *
 * Bewusst ohne AnimatePresence: das Banner muss beim Entscheid zuverlässig
 * verschwinden. Ein steckengebliebener Exit-Node bleibt sonst als unsichtbares
 * Overlay liegen und fängt Klicks am unteren Seitenrand ab.
 */
